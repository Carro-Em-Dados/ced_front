...
export default function OrganizationModal({ setWorkshops }: Props) {
  ...
  useEffect(() => {
    ...
    if (profileType === "basic") {
      ...
      setMaintenanceAlarmCount(basicContractData.maxManuntenanceAlarmsPerUser.toString());
  ...
  return (
    <>
      <Button color="success" className={styles.button} onClick={onOpen}>
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                {tab === "tab1" && (
                  <div className={clsx(styles.form, "flex flex-col gap-4")}>
                    ...
                    <div>
                      <input className={styles.modalInput} placeholder="CNPJ*" value={cnpj} onChange={(e) => setCnpj(e.target.value)} />
                    </div>
                    <div>
                      <input
                        className={styles.modalInput}
                ...
                {tab === "tab3" && (
                  <div className={clsx(styles.form, "flex flex-col gap-4")}>
                    ...
                    <div>
                      <input className={styles.modalInput} placeholder="CNAE*" value={cnae} onChange={(e) => setCnae(e.target.value)} />
                    </div>
                    <div>
                      <input
                        className={styles.modalInput}
              ...
              <ModalFooter>
                {tab !== "tab1" && (
                  <Button className={`${styles.modalButton} bg-gradient-to-r from-blue-400 via-green-500 to-yellow-500`} onClick={prevPage}>
                    Voltar
                  </Button>
                )}
                <RadioGroup
                ...
                <Button color="success" className={styles.modalButton} onClick={tab === "tab4" ? createWorkshop : nextPage}>
