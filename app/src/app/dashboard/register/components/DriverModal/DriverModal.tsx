      ...
      try {
        ...
        if (!querySnapshot.empty) {
          ...
          if ((existingDriver?.workshops ?? []).find((w: string) => w !== ""))
            return alert("Já existe um motorista com esse email associado a uma oficina.");
        ...
        let driver = {
          ...
          role: "client",
          register: register,
          workshops: currentUser?.role === "master" ? selectedWorkshop : currentUser?.workshops || "",
        };
              ...
              <ModalBody>
                <div className={styles.form}>
                  ...
                  <div>
                    ...
                    <input className={styles.modalInput} placeholder="Gênero" value={gender} onChange={(e) => setGender(e.target.value)} />
                  </div>
                  <div>
                    <input
                      className={styles.modalInput}
