...
export default function EditVehicleModal({ vehicle, setVehicles }: Props) {
  ...
  const [manufacturer, setManufacturer] = useState<string>(vehicle.manufacturer);
  ...
  const updateVehicle = async () => {
    ...
    try {
      ...
      setVehicles((vehicles) => vehicles.map((veh) => (veh.id === vehicle.id ? { ...veh, ...updatedVehicle } : veh)));
          ...
          {(onClose) => (
            <>
                    ...
                    {failed.model ? (
                      ...
                      >
                        {vehiclesModels.map((model) => (
                          <AutocompleteItem value={model.nome} key={model.nome}>
                            {model.nome}
                          </AutocompleteItem>
                        ))}
                      </Autocomplete>
              ...
              <ModalFooter>
                ...
                <Button color="success" className={styles.modalButton} onClick={updateVehicle} disabled={loading}>
                  Salvar
                </Button>
              </ModalFooter>
            </>
