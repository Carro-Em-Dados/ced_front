		...
		>
			<DropdownTrigger>
				<Button
					...
					variant="bordered"
				>
					{props.value ? getLabel(props.value) : props.placeholder}
					<div style={{ width: "2.6em", height: "100%" }}>
						<span className={isOpen ? styles.activevl : styles.vl} />
						<div className={styles.caretContainer}>
							<svg
								className={isOpen ? styles.activeCaret : styles.caret}
								width="24"
								height="13"
								viewBox="0 0 24 13"
								fill="none"
							...
							>
								<path
									d="M1 1.6474L10.0009 10.6483C10.7819 11.4293 12.0483 11.4293 12.8293 10.6483L22.0625 1.4151"
									strokeWidth="2"
									strokeLinecap="round"
								/>
							</svg>
